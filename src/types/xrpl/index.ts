import type { LedgerStream, TransactionStream as _TransactionStream, RequestResponseMap } from 'xrpl'
...
type LedgerResponse = (_LedgerResponse & { ledger: { close_time_iso: string, transactions: (_LedgerResponse['ledger']['transactions'][number] & { hash: string })[] } })
...
export { LedgerStream, TransactionStream, LedgerResponse }
